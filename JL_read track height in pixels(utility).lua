...
-- Reads the height of a track in pixels and shows it in the reaper console.
-- If several tracks is selected it shows and error message and do not get called.
...
function GetTrackHeight()
    ...
    elseif (trackSum == 1) then
        ...
        Print("Track height is "..trackHeight.." in pixels.")
    end
end
